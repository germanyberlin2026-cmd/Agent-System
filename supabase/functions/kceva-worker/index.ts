...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({
      ...
      cost,
      execution_context: { agent_prompt: true, skills: selectedSkills.map((skill: any) => ({ name: skill.name, version: skill.version })) },
    }), {
